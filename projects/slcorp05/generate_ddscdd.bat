...
set "SYSTEM_XML_PATH=%~dp0\user_work\wpc_system.xml"
set "JRE_HOME=C:\RTI\rti_connext_drive-4.0.0\rti_connext_dds-7.3.1\resource\app\jre\x64Win64"

set "OUTPUT_DIR=.\"
set "DEPLOYMENT_NAME=WPC_Domain_1_Deployment"
...
set "APPLICATION_NAME=WPC_Domain_1_Application"
set "DOMAIN_PARTICIPANT_NAME=WPC_Domain_1"
